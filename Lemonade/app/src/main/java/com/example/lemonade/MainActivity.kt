    ...
    Scaffold(
        ...
        Surface(
            ...
            when (currentStep) {
                1 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.tapSelect,
                ...
                2 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.keepTap,
                ...
                4 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.tapEmpty,
            ...
            Button(
                ...
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .padding(dimensionResource(R.dimen.buttonPadding))
                )
            }
            Spacer(modifier = Modifier.height(dimensionResource(R.dimen.paddingVertical)))
            Text(
